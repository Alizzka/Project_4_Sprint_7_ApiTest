// Отдельный тест на проверку отсутствия поля логина или пароля при атворизации сущетсвующего курьера
// Без анотации After чтобы курьер не удалялся дважды, так как нужно получить id курьера для авторизации,
// при получении которого курьер удаляется, если есть анотация after в классе
...
public class LoginCourier2Test {
